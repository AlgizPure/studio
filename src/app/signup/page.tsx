...
/**
 * Страница регистрации, позволяющая пользователям создавать учетную запись с помощью электронной почты и пароля или через Google.
...
export default function SignUpPage() {
  ...
  /**
   * Обрабатывает вход пользователя через Google.
   */
