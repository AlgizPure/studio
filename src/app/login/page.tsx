...
/**
 * @fileoverview Страница входа пользователя.
 * Позволяет пользователям входить в систему с помощью email/пароля или через Google.
 */
...
export default function LoginPage() {
  ...
  /**
   * Обрабатывает вход с помощью email и пароля.
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-200px)]">
      <Card className="w-full max-w-sm">
        <CardHeader>
          ...
          <CardDescription>Введите свой email ниже, чтобы войти в свою учетную запись.</CardDescription>
        </CardHeader>
